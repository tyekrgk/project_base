...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
			...
			'upload_dir' => dirname(dirname($this->get_server_var('SCRIPT_FILENAME'))).'/tempfile/',
			'upload_url' => 'upload/',
			'user_dirs' => false,
			'mkdir_mode' => 0755,
			'param_name' => 'files',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $file->name = $this->getRandFileName($file->name);
...
//        die();
    ...
    public function getRandFileName($filename){
        $last =$exten[count($exten = explode('.', $filename)) - 1];
        $n_file_name = md5(microtime());
        $n_file_name  = $n_file_name.'.'.$last;
        return $n_file_name;
    }
}
