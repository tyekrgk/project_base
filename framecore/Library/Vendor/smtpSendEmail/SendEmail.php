...
class SendEmail {
	...
	public function send_ringtone($to,$m4r,$title,$id)
	{
        ...
        $mail->Host = 'smtp.mailgun.org';      // SMTP 服务器
        $mail->Port = 587;                   // SMTP服务器的端口号
        $mail->Username = 'ringtong@apphehe.com';               // SMTP服务器用户名
        $mail->Password = '7368&message3!55';            // SMTP服务器密码
        ...
        $mail->AddAttachment($fileName); // 附件
