...
class SAndroidTopContentModel extends Model
{
    protected $trueTableName = 'sandroid_top_content';
    protected $_validate = array(
        // array('data_id','','data_id必须唯一',0,'unique',1),
     ...
     * @return mixed
     */
    public function getAndroidTopContentByCondition($option = 'select',$where = array())
    {
        switch($option){
            case 'find':
